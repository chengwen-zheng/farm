    ...
    switch (arch) {
      case 'x64':
        if (existsSync(join(currentDir, '../npm/win32-x64-msvc/index.farm'))) {
          ...
          binPath = require.resolve('remove-console-win32-x64-msvc');
        }
      ...
      case 'ia32':
        if (existsSync(join(currentDir, '../npm/win32-ia32-msvc/index.farm'))) {
          ...
          binPath = require.resolve('remove-console-win32-ia32-msvc');
        }
      ...
      case 'arm64':
        if (existsSync(join(currentDir, '../npm/win32-arm64-msvc/index.farm'))) {
          ...
          binPath = require.resolve('remove-console-win32-arm64-msvc');
        }
    ...
    switch (arch) {
      case 'x64':
        if (existsSync(join(currentDir, '../npm/darwin-x64/index.farm'))) {
          ...
          binPath = require.resolve('remove-console-darwin-x64');
        }
        break;
      case 'arm64':
        if (existsSync(join(currentDir, '../npm/darwin-arm64/index.farm'))) {
          ...
          binPath = require.resolve('remove-console-darwin-arm64');
        }
        break;
      default:
      ...
      case 'arm64':
        if (isMusl()) {
          if (
            ...
            binPath = require.resolve('remove-console-linux-arm64-musl');
          }
        } else {
          if (
            ...
            binPath = require.resolve('remove-console-linux-arm64-gnu');
          }
        }
        break;
      default:
